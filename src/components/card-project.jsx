...
function CardProject({ id, title, imageUrl, description}) {
        ...
        <div>
            ...
            >
                <div className="  flex flex-col items-center bg-[rgba(255,255,255,.8)] transform ease-out duration-400 hover:transform  ">
                    <div
                        className="  transition-all duration-300 bottom-[-25%] absolute left-0 w-full h-[50%] bg-[rgba(255,255,255,0.89)] text-[#2b3144] "
                        style={{
                            transform: isHovered ? 'translateY(-50%)' : 'translateY(0)',
                            paddingBottom: isHovered ? '20px' : '0', // Ajout de cet ajustement pour éviter le chevauchement
                        }}
                    >
                        ...
                        >
                            ...
                            <span
                                className="flex self-stretch mt-10 mb-1  border-b border-solid border-[#2b3144] "></span>
                            <button
                                id="page-card-link-35"
                                className="m-5 bg-[#2b3144] text-white font-bold px-4 py-2 rounded transition-all duration-300 hover:bg-transparent hover:text-[#2b3144] hover:border-[#2b3144] border hover:border-solid"
                                onClick={() => window.location.href = "https://mosaic.mnhn.fr/realisations/spipoll/"}
